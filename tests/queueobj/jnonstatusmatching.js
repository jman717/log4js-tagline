...
qObj.init().process({
  ...
  qObj.logMsg({ msg: `test success: json status non matching objects processed with no errors.`, type: "success" })
}, (error) => {
...
[2023-02-27T18:14:39.872] [trace] myLog - (msg: "processing object id 100 name(all) status(new). Do a bunch of stuff here.")
[2023-02-27T18:14:39.874] [trace] myLog - (msg: "processing object id 102 name(top_one) status(new). Do a bunch of stuff here.")
[2023-02-27T18:14:39.876] [trace] myLog - (msg: "processing object id 103 name(bottom_one) status(new). Do a bunch of stuff here.")
[2023-02-27T18:14:39.877] [trace] myLog - (msg: "processing object id 105 name(status) status(delete). Do a bunch of stuff here.")
[2023-02-27T18:14:39.878] [trace] myLog - (msg: "processing object id 107 name(version) status(new). Do a bunch of stuff here.")
[2023-02-27T18:14:39.879] [info] myLog - (msg: "id = 100 name(all) status(new)")
[2023-02-27T18:14:39.881] [info] myLog - (msg: "id = 102 name(top_one) status(new)")
[2023-02-27T18:14:39.881] [info] myLog - (msg: "id = 103 name(bottom_one) status(new)")
[2023-02-27T18:14:39.883] [info] myLog - (msg: "id = 105 name(status) status(delete)")
[2023-02-27T18:14:39.885] [info] myLog - (msg: "id = 107 name(version) status(new)")
[2023-02-27T18:14:39.889] [info] myLog - (msg: "test success: json status non matching objects processed with no errors.")
*/